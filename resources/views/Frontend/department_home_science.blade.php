...
@section('content')
    ...
    <div class="container-fluid"
        ...
        <p class="text-center">Department of Home Science</p>
    </div>
    <!-- slider ends here -->
    ...
    <div class="container">
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            <div class="col-md-4 col-sm-4">
                <div class="pic">
                    <img src="{{ asset('Frontend/images/department/homescience.jpg') }}">

                </div>
            </div>
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                    <h2><strong>About the Home Science</strong></h2>
                    <p style="text-align: justify;font-size:13px;">The University Department of Home Science was established in 1991. At present, it conducts MA Home Science two-year Course with Semester System of examination. The sanctioned intake of the Department is 120 students per year, and as of now, there are total of 134 students of PG in Session 2014-16 and 2013-15 on its Roll. The Department has successfully conducted six-month pre-Ph.D. course on Research Methodologies for the PRT-passed research scholars.

                        Various activities initiated in the Department during the academics year 2019-20 include the lecture series, brainstorming session, debate competition, Poster making competition, slogan writing competition and competition on making “best out of waste”. These activities have brought forth an academic flexibility to facilitate a holistic development of students.</p>
                </div>
            </main>
        </div>
        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper" style="margin-top: 40px;">
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                        ...
                        <p style="text-align: justify;font-size:13px;">For the first time, PG final semester students were encouraged to carried out research in all the five branches of Home Science i.e. Food and Nutrition, Clothing and textile, Family Resource Management, Human Development and Extension Education. Students gave a wonderful response and submitted the dissertation in almost all the branches mentioned above. This practice would further identify the student’s interest area and would provide the opportunity to each one of them to excel in their own field of choice. Furthermore, it will provide a variety in the researches produced by the department.</p>

                </div>
            </main>
            <div class="col-md-4 col-sm-4">
                <div class="pic">
                    <img src="{{ asset('Frontend/images/department/homescience1.jpg') }}">
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Dr. Shyama Choudhary</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>04.02.1992 - 24.08.2008</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Dr. Nirmala  Jha</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>25.08.2008 - 31.08.2011</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Dr. Sarojini Dev</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>01.09.2011 - 31.08.2014</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Dr. Eesha Sinha</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>01.09.2014 - 31.12.2016</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
