        ...
        <main class="col-md-9 float-left">
            ...
            <div class="col-md-12" id="content_main">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-3" >
                                        <img src="{{asset('Frontend/images/banners/registrar.jpg')}}" alt="">
                                        </div>
                                        <div class="col-sm-6"><h3 style="color:#7C0000;">Dr. Mushtaque Ahmad</h3>
                                            <p>Registrar , LNMU, Darbhanga,<br/> Bihar</br>
                                                registrar@lnmu.ac.in</p>
                                        </div>
