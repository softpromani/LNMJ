        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main" style="font-size: 12px;">
                ...
                <div class="page-header">
                    <h2 class="display-4 font-weight-light text-center">Composition of IQAC</h2>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <ul style="font-size: 15px;">
                          <li> <a href="https://lnmu.ac.in/iqac/Composition%20of%20IQAC/IQAC_Reconstitution_201920.pdf" target="_blank">IQAC_Reconstitution_201920</a></li>
                          <li> <a href="https://lnmu.ac.in/iqac/Composition%20of%20IQAC/IQAC_Reconstitution_236-64.pdf" target="_blank">IQAC_Reconstitution_236-64</a></li>
                        </ul>
                      </div>
                </div>
