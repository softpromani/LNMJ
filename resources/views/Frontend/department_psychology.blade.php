    ...
    <div class="container">
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            <div class="col-md-4 col-sm-4">
                <div class="pic">
                    <img src="{{ asset('Frontend/images/department/psychology.png') }}">

                </div>
            </div>
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                    <h2><strong>About the Psychology</strong></h2>
                    <p style="text-align: justify;font-size:13px;">The Post Graduate Department of Psychology was established in 1976 with a commitment to educate and train students of Mithila Region in particular to prepare professionals for significantly contributing to the development of Mithila Region. The Department of Psychology is also dedicated to cultivate mastery over the relevant skills in the areas of human development and behavior.

                        This Department has a total strength of 05 teaching faculty members in which 02 Professor and 03 Associate Professors are working. We have given due emphasis on acquisition of knowledge and skills through theoretical understanding and its practical implications of the courses we taught. Seminar, presentations and discussions, experiential exercises etc are incorporated in the curriculum and being practiced as regular phenomena for all round development of our students.</p>
                </div>
            </main>
        </div>
        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper" style="margin-top: 40px;">
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                        ...
                        <p style="text-align: justify;font-size:13px;">The departmental research is centered on contemporary issues as stress, pro-social behaviour, ageing, drug abuse, community mental health, disability, neuropsychological assessment, organisational behaviour, rehabilitation, educational problems etc. Time to time, we organises conferences, seminars, workshops, etc. for updation of our faculty and students. Our planning is to introduce some certificate and Post Graduate Diploma Courses in order to enhance the employability of our students in global scenario.
                            Without any discrimination of caste, Creed and religion as well as nation’s building at large.</p>

                </div>
            </main>
            <div class="col-md-4 col-sm-4">
                <div class="pic">
                    <img src="{{ asset('Frontend/images/department/psychology1.jpg') }}">
