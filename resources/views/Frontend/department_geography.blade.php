...
@section('content')
    ...
    <div class="container-fluid"
        ...
        <p class="text-center">Department of Geography</p>
    </div>
    <!-- slider ends here -->
    ...
    <div class="container">
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            <div class="col-md-4 col-sm-4">
                <div class="pic">
                    <img src="{{ asset('Frontend/images/department/geography.jpg') }}">

                </div>
            </div>
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                    <h2><strong>About the Geography</strong></h2>
                    <p style="text-align: justify;font-size:13px;">In the era of Globalization Geography has emerged as most significant and relevant field of study. Accordingly the University Department of Geography was established in year 1972 with the vision to produce the best geographers and analyst for the academic and corporate world. Quality teaching is the most important objective of the department. The department is actively engaged in research development and invites eminent geographers to deliver lecture series and interact with the faculty members.</p>
                </div>
            </main>
        </div>
