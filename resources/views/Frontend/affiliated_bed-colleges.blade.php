                                    ...
                                    <div class="item-content-inner">
                                        <h5 class="item-title">
                                            <a href="#" style="color:#7C0000" title="">Home</a> | <a
                                                href="#" style="color:#7C0000" title="">Affilliated B.Ed
                                                Colleges</a>
                                            </h3>
                                    </div>
                                </div>
        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
                ...
                <div class="page-header">
                    <h2 class="display-4 font-weight-light text-center">Affilliated B.Ed Colleges</h2>
                </div>
                <div class="panel-body">
                    <object data="{{asset('upload/colleges/B.Ed. Colleges.pdf')}}"
