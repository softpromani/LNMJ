...
@section('content')
    ...
    <div class="container-fluid"
        ...
        <p class="text-center">Department of History</p>
    </div>
    <!-- slider ends here -->
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Prof. Ambika Prasad Sharma</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        </td>
