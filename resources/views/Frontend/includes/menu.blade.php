        ...
        <div class="row">
            <div id="yt_mainmenu" class="col-md-12 col-sm-12">
                <ul id="meganavigator" class="clearfix navi">
                    ...
                    <li class="level1 havechild">
                        <a title="Pages " class="level1 havechild  item-link" href="#"><span
                                class="menu-title">Student Support</span></a>
                        <div class="level2 menu mega-content">
                ...
                <div id="yt-responivemenu" class="yt-resmenu">
                    <button data-target=".nav-collapse" data-toggle="collapse" class="btn btn-navbar collapsed"
                        type="button"><i class="fa fa-bars"></i>Menu</button>
                    <div id="resmenu_sidebar" class="nav-collapse collapse">
                        <ul class="nav resmenu">
                            <li><a title="Home " href='#' class="active">Home</a></li>
                            <li class="haveChild level1"><a title="Explore " href='#'>About Us</a><span
                            ...
                            <li class="haveChild level1"><a title="Explore " href='#'>Administration</a><span
                                    class="menuress-toggle"></span>
                                <div class="res-wrapnav">
                                    <ul class="nav">
                            ...
                            <li class="haveChild level1"><a title="Explore " href='#'>Academics</a><span
                                    class="menuress-toggle"></span>
                                <div class="res-wrapnav">
                                    <ul class="nav">
                                        ...
                                        <li><a href='#'>Academic Innovations</a>
                                        </li>
                                        <li><a href='#'>Distance Education</a></li>
                                        <li><a href='#'>Institutional Linkages</a>
                                        </li>
