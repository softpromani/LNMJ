        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <main class="col-md-8 col-sm-8">
                <div class="col-md-12" id="content_main">
                    ...
                    <p style="text-align: justify;font-size:13px;">TKeeping changing needs in mine for professional education and training in society, Department of Sociology was established in the year 1975. The department prepares students to become effective and efficient social workers in the new developed era and emphasis is given on quality education and promoting a culture of enquiry and quality of life. The Department provides direct learning with individuals, groups and developed organizations to the students. The Department gladly accepts a challenge to train the students as per the contemporary needs of the society.</p>
                </div>
            </main>
        </div>
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Dr. Chandeshwar Jha</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>10 oct 1984 - 31 March 1993</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Dr. Avinash Chandra Mishra</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>01 April 1993 - 10 Sept 1997</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Dr. Lawanaya Kirti Singh ‘Kabya’</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>25 August 2017 - 06 Sep 2020</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Prof. Pushpam Narayan</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>26 August 2014 - 24 August 2017</td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>Dr. Mamta Rani Thakur</td>
                                        <td>N/A</td>
                                        <td>N/A</td>
                                        <td>7 Sep 2020 Onward</td>
                                        </td>
                                    </tr>
