                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="user_icon">
                                                <img src="{{ asset('Frontend/images/faculty/sahnaj_head.jpg') }}"
                                                    alt="">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="user_icon">
                                                <img src="{{ asset('Frontend/images/faculty/rn_prof.jpg') }}"
                                                    alt="">
                                            </div>
                                        </td>
                                    </tr>
